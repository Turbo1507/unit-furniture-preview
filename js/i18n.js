...
window.I18N = {
  ru: {
    ...
    "pp.custom.drawing": "Точный чертёж с размерами и образцы материалов — по запросу.",
    ...
    "f.scope": "Объём заказа", "f.sc.item": "Одна позиция", "f.sc.zone": "Комплект на зону / комнату",
    "f.sc.full": "Весь объект целиком", "f.sc.bulk": "Несколько юнитов / опт",
    "f.deadline": "Нужна к дате (если есть)",
  ...
  en: {
    ...
    "pp.custom.drawing": "Exact dimensioned drawing and material samples — on request.",
    ...
    "f.scope": "Order scope", "f.sc.item": "A single item", "f.sc.zone": "A set for one zone / room",
    "f.sc.full": "The whole property", "f.sc.bulk": "Multiple units / wholesale",
    "f.deadline": "Needed by (if any)",
